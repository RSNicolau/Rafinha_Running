...
const PLANS = [
  {
    ...
    features: [
      ...
      'Treino na Concha Acústica (terças)',
  ...
  },
  {
    ...
    period: '/3 meses',
    amount: 49500,
    description: 'Parcela única — economia de R$27',
    popular: true,
    badge: 'Mais popular',
    features: [
      'Tudo do Mensal',
      'Equivale a R$165/mês',
  ...
  },
  {
    ...
    period: '/6 meses',
    amount: 96000,
    description: 'Parcela única — economia de R$84',
    popular: false,
    badge: 'Melhor valor',
    features: [
      'Tudo do Mensal',
      'Equivale a R$160/mês',
      'Sem renovação automática',
    ],
  },
];
