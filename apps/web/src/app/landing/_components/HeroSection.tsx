      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-red-50 border border-red-100 rounded-full">
            ...
            <span className="text-xs font-semibold text-[#DC2626] uppercase tracking-widest">Plataforma de Assessoria de Corrida</span>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-gray-400">14 dias grátis · Sem cartão de crédito · Cancele quando quiser</p>
