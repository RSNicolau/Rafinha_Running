      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-4">
          {isAthlete ? (
            ...
            <>
              <Link href="/register" className="inline-flex items-center gap-2 justify-center px-8 py-4 bg-[#DC2626] hover:bg-red-700 text-white font-bold rounded-2xl text-lg transition-colors shadow-lg shadow-red-200/60">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
